...
module RailsLti2Provider
  class LtiLaunch < ActiveRecord::Base
    ...
    def self.check_launch(lti_message)
      ...
      unless IMS::LTI::Services::MessageAuthenticator.new(lti_message.launch_url, lti_message.post_params.merge(lti_message.oauth_params), tool.shared_secret).valid_signature?
